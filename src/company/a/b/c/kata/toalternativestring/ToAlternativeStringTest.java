...
public class ToAlternativeStringTest {
    ...
    public void fixedTests() {
        ...
        assertEquals("HELLO world", ToAlternativeString.toAlternativeString("hello WORLD"));
        assertEquals("hEllO wOrld", ToAlternativeString.toAlternativeString("HeLLo WoRLD"));
        assertEquals("Hello World", ToAlternativeString.toAlternativeString(ToAlternativeString.toAlternativeString("Hello World")));
        ...
        assertEquals("sTRINGuTILS.TOaLTERNATINGcASE", ToAlternativeString.toAlternativeString("StringUtils.toAlternatingCase"));
    }
    ...
    public void kataTitleTests() {
        ...
        assertEquals("altERnaTIng cAsE", ToAlternativeString.toAlternativeString("ALTerNAtiNG CaSe"));
        assertEquals("ALTerNAtiNG CaSe <=> altERnaTIng cAsE", ToAlternativeString.toAlternativeString("altERnaTIng cAsE <=> ALTerNAtiNG CaSe"));
        assertEquals("altERnaTIng cAsE <=> ALTerNAtiNG CaSe", ToAlternativeString.toAlternativeString("ALTerNAtiNG CaSe <=> altERnaTIng cAsE"));
    }
}